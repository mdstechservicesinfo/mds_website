    ...
    try {
      await emailjs.send(
        ...
        EMAILJS_TEMPLATE_ID,
        {
          name: form.name,
          email: form.email,
          title: `Package Inquiry: ${selectedPackage} Package`,
  ...
  return (
    <div style={{ background: '#040610', minHeight: '100vh', color: '#fff', overflowX: 'hidden' }}>
      <style>{`
        ...
        .pkg * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @media (max-width: 768px) {
          ...
          .packages-section { padding: 60px 20px 80px; }
      ...
      <Helmet>
        ...
        <meta name="description" content="Choose from our Basic, Standard, or Premium website and CMS packages. Professional software solutions tailored to your business needs." />
        <meta property="og:title" content="Packages | MDS Software Development Services" />
        <meta property="og:url" content="https://mdstechservices-ph.web.app/packages" />
      </Helmet>
      ...
      <section className="page-hero">
        ...
        <p className="page-desc">
          Professional business websites integrated with a Content Management System. Choose the package that fits your business needs.
        </p>
      </section>
        ...
        <div className="packages-grid">
          {packages.map((pkg, i) => (
            ...
            >
              ...
              <button
                className="pkg-btn"
                style={{ background: `linear-gradient(135deg, ${pkg.color}, ${pkg.color}bb)`, boxShadow: `0 8px 24px ${pkg.color}44` }}
                onClick={() => { setSelectedPackage(pkg.name); setStatus(''); setForm({ name: '', email: '', company: '', message: '' }); }}
              >
                Get Started →
              </button>
            </div>
          ...
          <div className="modal-box" onClick={e => e.stopPropagation()}>
            <div className="modal-header">
              <div>
                ...
                <div className="modal-subtitle">Fill out the form and we'll get back to you within 24 hours</div>
              </div>
